...
;;;;; auto-complete
   ...
   `(popup-scroll-bar-background-face ((t (:background ,github-text))))
...
;;;;; company-mode
   ...
   `(company-tooltip-common-selection ((t (:foreground ,github-text))))
   `(company-scrollbar-fg ((t (:background ,github-text))))
   `(company-scrollbar-bg ((t (:background ,github-white))))
   `(company-preview ((t (:background ,github-text))))
   `(company-preview-common ((t (:foreground ,github-text :background ,github-selection))))
;;;;; bm
...
;;;;; ivy
   ...
   `(ivy-current-match ((t (:foreground ,github-keyword :underline t))))
   `(ivy-minibuffer-match-face-1 ((t (:background ,github-white))))
   `(ivy-minibuffer-match-face-2 ((t (:background ,github-border))))
   `(ivy-minibuffer-match-face-3 ((t (:background ,github-border))))
