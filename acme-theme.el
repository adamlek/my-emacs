...
;;;;; font lock
   ...
   `(font-lock-comment-face                       ((t (:foreground ,fg-alt :italic t))))
   `(font-lock-comment-delimiter-face             ((t (:foreground ,fg-light :italic t))))
   ...
   `(font-lock-keyword-face                       ((t (:foreground ,blue)))) ; if, else, for, while, return...
...
;;;;; mode-line/sml-mode-line
   ...
   `(mode-line-inactive                           ((t (:foreground ,fg :background ,bg :box t))))
